...
const getBlogs = async function (req, res) {
  try {
    ...
    if (Object.keys(req.query).length === 0) {
      ...
      let result = await BlogsModel.find({ isDeleted: false, $or: [{ authorId: req.query.authorId }, { tags: req.query.tags }, { category: req.query.category }, { subcategory: req.query.subcategory }] });
